...
export function downloadGuestTemplate() {
  const sampleData = [
    { nombre: 'Ana García', celular: '5512345678', id_familia: 'garcia' },
    { nombre: 'Carlos García', celular: '5512345679', id_familia: 'garcia' },
    { nombre: 'María García', celular: '', id_familia: 'garcia' },
    { nombre: 'Pedro López', celular: '5598765432', id_familia: 'lopez' },
    { nombre: 'Laura López', celular: '', id_familia: 'lopez' },
    { nombre: 'Roberto Martínez', celular: '5511223344', id_familia: '' },
  ]

  const ws = XLSX.utils.json_to_sheet(sampleData, {
    header: ['nombre', 'celular', 'id_familia'],
  })
